                    ...
                    <form style="margin-top: 1.5rem" action="" method="post">
                        <div style="margin-bottom: 1.75rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0" type="text" name="username" id="" placeholder="Your Username" autocomplete="on" required />
                            </div>
                        </div>
                        <div style="margin-top: 1rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0" type="password" name="password" id="password-content-3-5" placeholder="Your Password" minlength="6" required />
