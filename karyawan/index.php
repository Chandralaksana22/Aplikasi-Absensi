...
$sql_check_absensi = "SELECT * FROM absensi WHERE employee_id = '$karyawan_id' AND DATE(waktu) = CURDATE()";
$result_check_absensi = mysqli_query($conn, $sql_check_absensi);

// Jika karyawan sudah absen hari ini, sembunyikan tombol absen
if (mysqli_num_rows($result_check_absensi) > 0) {
    $absensi_sudah_dilakukan = true;
} else {
    $absensi_sudah_dilakukan = false;
}
?>
                    ...
                    <div class="row mt--2">
                        <div class="col-lg-4">
                            <div class="card card-profile">
                                ...
                                <div class="card-body">
                                    <div class="user-profile text-start">
                                        <div class="name"><?php echo $Nama; ?></div>
                                        <div class="job"><?php echo $role; ?></div>
                                        <div class="desc"><?php echo $nip; ?></div>

                                    </div>
                                </div>

                                <div class="card-footer">
                                    <div class="row user-stats text-start">
                                        <div class="col-12">
                                            <h3 class="fw-bold">Waktu</h3>
                                            <div class="d-flex">
                                                <div class="text-primary fw-bold" style="font-size: 18px;" id="time"></div> <span style="font-size: 18px;" class="ml-3">GMT + 7</span>
                                            </div>
                                            <div class="fw-bold" id="date"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <?php
                                        if (!$absensi_sudah_dilakukan) {
                                            echo '<div class="col-lg-6">
            <form action="" method="post">
                <input class="btn btn-primary w-100 mt-3" type="submit" name="submit_absen" value="Absen">
            </form>
          </div>';
                                            echo '<div class="col-lg-6">
          <a href="izin_sakit_form.php" class="btn btn-warning w-100 mt-3">Tidak Bisa Hadir</a>
        </div>';
                                        } else {
                                            echo '<div class="col-lg-6">
            <p class="text-success">Anda sudah melakukan absensi hari ini.</p>
          </div>';
                                        }
                                        ?>
                                        <!-- <div class="col-lg-6">
