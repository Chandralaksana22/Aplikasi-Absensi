...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM employees WHERE NIP = '$NIP' AND password = '$password'";
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);

    if ($row) {
        $_SESSION['karyawan_logged_in'] = true;
                ...
                <div class="right mx-lg-0 mx-auto">
                    ...
                    <form style="margin-top: 1.5rem" action="" method="post">
                        <div style="margin-bottom: 1.75rem">
                            <label for="" class="d-block input-label">NIP</label>
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0" type="text" name="NIP" id="" placeholder="NIP" autocomplete="on" required />
                            </div>
                        </div>
                        <div style="margin-top: 1rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0" type="password" name="password" id="password-content-3-5" placeholder="Your Password" required />
                        ...
                        <button class="btn btn-fill text-white d-block w-100" type="submit" value="Login">
